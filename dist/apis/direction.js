...
exports.getDirection = exports.Direction = void 0;
exports.Direction = {
    definition: [
        `/**
...
const getDirection = function (rateLimit) {
    return {
        definition: [
            `/**
        * \`Direction\` API is how you control **HotRod**.
        ...
        * You can only call it ${rateLimit} time${rateLimit > 1 ? "s" : ""} inside the \`gameLoop\`.
        * So you can only move the **HotRod** ${rateLimit} time${rateLimit > 1 ? "s" : ""} per turn.
        * If you call it more than ${rateLimit} time${rateLimit > 1 ? "s" : ""}, only the first ${rateLimit} call${rateLimit > 1 ? "s" : ""} will be executed.
        * 
        **/
       type Direction = {
           up: () => void 
...
exports.default = exports.Direction;
